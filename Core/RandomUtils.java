...
public class RandomUtils {
    ...
    /**
     * Rearranges the elements of type ROOM of the specified list in uniformly random order.
     *
     * @param a the list to shuffle
     * @throws IllegalArgumentException if {@code a} is {@code null}
     */
    public static void shuffle(Random random, List<Room> a) {
        int n = a.size();
        for (int i = 0; i < n; i++) {
            int r = i + uniform(random, n - i);     // between i and n-1
            Room temp = a.get(i);
